...
- (id)initWithFieldSize:(CGSize)textFieldSize fontName:(NSString *)fontName andFontSize:(CGFloat)fontSize {
	if (self = [super init]) {
		...
		//self.label = [CCLabelTTF labelWithString:@" "  dimensions:textFieldSize halignment:kCCTextAlignmentLeft fontName:fontName fontSize:fontSize];
		self.label=[CCLabelTTF labelWithString:@" " fontName:fontName fontSize:fontSize dimensions:textFieldSize hAlignment:kCCTextAlignmentLeft lineBreakMode:kCCLineBreakModeClip];
       // self.label=[CCLabelTTF labelWithString:(NSString*)string fontName:(NSString*)name fontSize:(CGFloat)size dimensions:(CGSize)dimensions hAlignment:(CCTextAlignment)alignment];
