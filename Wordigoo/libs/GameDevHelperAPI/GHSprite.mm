...
-(CGAffineTransform) nodeToParentTransform
{
    if(body){
        ...
        if ( _ignoreAnchorPointForPosition ) {
            pos.x += _anchorPointInPoints.x;
            pos.y += _anchorPointInPoints.y;
        }
        ...
        if( ! CGPointEqualToPoint(_anchorPointInPoints, CGPointZero) ){
            pos.x += c*-_anchorPointInPoints.x + -s*-_anchorPointInPoints.y;
            pos.y += s*-_anchorPointInPoints.x + c*-_anchorPointInPoints.y;
        }
